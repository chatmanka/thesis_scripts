...
#
# PURPOSE
#   Calculates station-level storm responsiveness as the OLS slope of station-
#   and month-demeaned salinity anomaly on 7-day antecedent rainfall (ppt per
#   inch). Uses radius-based rainfall aggregation across all gauges within 30
#   km. REPLACES storm_vulnerability.R, which contained a gauge-matching
#   error.
#
