...
#
# PURPOSE
#   Unified network analysis and interactive visualisation pipeline using the
#   FINAL_June2026 roster and edge list. Calculates degree and betweenness
#   centrality via igraph and builds the interactive visNetwork product.
#
...
clean_names <- function(text) {
  str_replace_all(text,
    "The Nature Conservancy SC Program",
    "The Nature Conservancy — SC Program")
}
